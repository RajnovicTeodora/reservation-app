            ...
            <Formik
                ...
                validationSchema={Yup.object().shape({
                    ...
                    maxGuest: Yup.number()
                        .max(100)
                        .min(1)
                        .required('Maximum guest number is required'),
            ...
            >
                {({
                    ...
                    <form noValidate onSubmit={handleSubmit} {...others}>
                        ...
                        <FormControl
                            fullWidth
                            error={Boolean(touched.maxGuest && errors.maxGuest)}
                            sx={{ ...theme.typography.customInput }}
                        >
                            <InputLabel htmlFor="outlined-adornment-maxGuest">
                        ...
                        <FormControl
                            fullWidth
                            error={Boolean(touched.minGuest && errors.minGuest)}
                            sx={{ ...theme.typography.customInput }}
                        >
                            <InputLabel htmlFor="outlined-adornment-maxGuest">
                        ...
                        <FormControl
                            fullWidth
                            error={Boolean(touched.automaticApproal && errors.automaticApproal)}
                            sx={{ ...theme.typography.customInput }}
                        >
                            <InputLabel htmlFor="outlined-adornment-automaticApproal">
                                Automatic approval
                            </InputLabel>
                            <Divider sx={{ flexGrow: 1 }} orientation="horizontal" />
                            <br />
                            ...
                            {touched.automaticApproal && errors.automaticApproal && (
                                <FormHelperText
                                    error
                                    id="standard-weight-helper-text-automaticApproal"
                                >
                        ...
                        <FormControl
                            ...
                            sx={{ ...theme.typography.customInput }}
                        >
                            <InputLabel htmlFor="outlined-adornment-benefits">
                                Benefits of accomodation
                            </InputLabel>
                            <OutlinedInput
